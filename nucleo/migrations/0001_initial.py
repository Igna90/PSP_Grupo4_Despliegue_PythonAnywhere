# Generated by Django 3.1.2 on 2022-01-14 18:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthDate', models.DateField(default=django.utils.timezone.now,verbose_name='Fecha de cumpleaños')),
                ('registerDate', models.DateTimeField(auto_now=True, verbose_name='Fecha de registro')),
                ('active', models.BooleanField(null=True, verbose_name='Activo')),
                ('role_user', models.CharField(choices=[('Cl', 'Cliente'), ('Em', 'Empleado'), ('Ad', 'Administrador')], default='Cl', max_length=50, verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nucleo.category', verbose_name='id')),
                ('idEmployee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idProject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nucleo.project', verbose_name='id')),
            ],
            options={
